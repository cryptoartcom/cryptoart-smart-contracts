# CryptoartNFT
[Git Source](https://github.com/cryptoartcom/cryptoart-smart-contracts/blob/703826f6667bb5ada61e11519325f0468fd8b0e4/src/CryptoartNFT.sol)
...
Emits an event signaling a change in visibility for a story. Token owner only.
...
|`storyId`|`string`|An identifier for the specific story (likely derived off-chain from event logs).|
